...
songIndex = 0;
songs = ['./assets/songs/sanhalo_werise.mp3', './assets/songs/lanadelrae_tepno.mp3', './assets/songs/tmass_upinflumes.mp3']; // object storing paths for audio objects
...
songArtists = ['San Halo', 'Lana Del Rae', 'T Mass']; // object storing track artists
songTitles = ["We Rise", "Tep No", "Up In"]; // object storing track titles
